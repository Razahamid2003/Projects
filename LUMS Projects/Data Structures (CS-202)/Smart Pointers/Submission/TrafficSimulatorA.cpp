    ...
    void runSimulation()//O(infinity). Considering it will run one cycle in a junction O(n)
    {
        ...
        while (end == false)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                {
                case 0:
                    cout<<"Signal for North is OPEN for "<<signalTime<<" seconds.\n-----------------------------------------\n";
                    n.runSignal(signalTime);
                    ...
                    break;
                case 1:
                    cout<<"Signal for East is OPEN for "<<signalTime<<" seconds.\n-----------------------------------------\n";
                    e.runSignal(signalTime);
                    ...
                    break;
                case 2:
                    cout<<"Signal for South is OPEN for "<<signalTime<<" seconds.\n-----------------------------------------\n";
                    s.runSignal(signalTime);
                    ...
                    break;
                case 3:
                    cout<<"Signal for West is OPEN for "<<signalTime<<" seconds.\n-----------------------------------------\n";
                    w.runSignal(signalTime);
